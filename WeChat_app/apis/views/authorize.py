...
from utils.response import wrap_json_response, ReturnCode, CommonRequestMixin
from .auth import already_authorized, c2s
...
class UserView(View, CommonRequestMixin):
    # 关注的城市、股票和星座
